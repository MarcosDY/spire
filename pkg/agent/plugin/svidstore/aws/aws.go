...
func (p *SecretsManagerPlugin) putX509SVID(ctx context.Context, secretID, region, kmsKeyID string, req *svidstorev1.PutX509SVIDRequest) error {
	// Create client
...
func createSecret(sm *secretsmanager.SecretsManager, req *svidstorev1.PutX509SVIDRequest, name string, kmsKeyID string) (*secretsmanager.CreateSecretOutput, error) {
	if name == "" {
