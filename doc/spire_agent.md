...
| SVIDStore        | [azure_keyvault](doc/plugin_agent_svidstore_azure_keyvault.md) | An SVIDStore which stores secrets in the Azure Key Vault with the resulting X509-SVIDs of the entries that the agent is entitled to. |
